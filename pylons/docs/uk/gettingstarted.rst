...
.. admonition:: Підказка
    ...
    Щоб ізолювати середовище від загальносистемних бібліотек, вкажіть наступну пцію:
...
2. чи включати підтримку :term:`SQLAlchemy` support
3. чи включати опції для :term:`Google App Engine` розробки

Натисніть enter біля кожного запиту шоб застосувати налашування по замовчуванню (Mako темплейти, без підтрикми :term:`SQLAlchemy`, без :term:`Google App Engine` налаштувань). 

Створена структура каталогів з посиланнями на більш детальну інформацію:
...
Каталог ``helloworld directory`` з вкладенями повинен виглядати на подобі цього:
...
Щоб створити простеньку hello world аплікацію, спочатку створіть в проекті
:term:`контроллер` щоб обробляти запити:
