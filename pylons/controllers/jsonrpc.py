...
__all__ = ['JSONRPCController', 'JSONRPC_PARSE_ERROR',
...
class JSONRPCError(BaseException):
    ...
    def as_dict(self):
        """ Return a dictionary representation of the error suitable
        for output in a JSON-RPC Response."""
