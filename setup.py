...
"""%version,
    ...
    install_requires=[
        "Routes>=1.6.2", "WebHelpers==dev,>=0.2.3dev-r1887", "Beaker==dev,>=0.6.3dev-r58",
        "Paste==dev,>=1.3.1dev-r6312", "PasteDeploy==dev,>=1.1.1dev-r6282", "PasteScript==dev,>=1.3.1dev-r6311",
        "Myghty>=1.1", "FormEncode>=0.7", "simplejson>=1.4", "decorator>=2.0.1",
        "nose>=0.9.2"
    ],
    classifiers=[
